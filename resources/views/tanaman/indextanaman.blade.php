    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="header-title">
                <h4 class="card-title">Tabel Tanaman</h4>
            </div>
            ...
            <div class="flex align-items-center list-user-action">
                <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="auto" title="Add" href="{{ route('admin/tanaman/create') }}">
            ...
            <div class="table-responsive">
                <table id="datatable" class="table table-striped" data-toggle="data-table">
                    ...
                    <tbody>
                        @if($tanaman->count() > 0)
                        @foreach($tanaman as $rs)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <th scope="row" class="font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {{ $loop->iteration }}
                            </th>
                            <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="{{ asset($rs->gambar_tanaman) }}" alt="Gambar Tanaman"></td>
                            <td>
                                {{ $rs->nama_tanaman }}
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex align-items-center list-user-action">
                                    <form action="">
                                        <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="auto" title="Edit" data-original-title="Edit" href="{{ route('admin/tanaman/edit', $rs->id_tanaman) }}">
                                            <span class="btn-inner">
                                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <form action="{{ route('admin/tanaman/destroy', $rs->id_tanaman) }}" method="POST" onsubmit="return confirm('Delete?')" class="float-right text-red-800">
                                        @csrf
                                        @method('DELETE')
