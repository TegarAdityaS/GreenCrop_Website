    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="flex align-items-center list-user-action">
                <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="auto" title="Add" href="{{ route('admin/kategori/create') }}">
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td>
                                <div class="d-flex align-items-center list-user-action">
                                    <form action="">
                                        <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="auto" title="Edit" data-original-title="Edit" href="{{ route('admin/kategori/edit', $rs->id_kategori) }}">
                                            <span class="btn-inner">
                                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <form action="{{ route('admin/kategori/destroy', $rs->id_kategori) }}" method="POST" onsubmit="return confirm('Delete?')" class="float-right text-red-800">
                                        @csrf
                                        @method('DELETE')
